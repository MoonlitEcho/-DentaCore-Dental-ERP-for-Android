...
public final class PatientDao_Impl implements PatientDao {
  ...
  public PatientDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPatient = new EntityInsertionAdapter<Patient>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `patients` (`id`,`name`,`phone`,`email`,`dob`,`gender`,`address`,`bloodGroup`,`allergies`,`medicalHistory`,`voiceNoteFilePath`,`createdAt`,`updatedAt`,`affectedTeeth`,`totalBilled`,`totalPaid`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement, final Patient entity) {
        ...
        if (entity.dob == null) {
          ...
          statement.bindString(5, entity.dob);
        }
        ...
        if (entity.address == null) {
          ...
          statement.bindString(7, entity.address);
        }
        if (entity.bloodGroup == null) {
          statement.bindNull(8);
        } else {
          statement.bindString(8, entity.bloodGroup);
        }
        if (entity.allergies == null) {
          statement.bindNull(9);
        } else {
          statement.bindString(9, entity.allergies);
        }
        if (entity.medicalHistory == null) {
          statement.bindNull(10);
        } else {
          statement.bindString(10, entity.medicalHistory);
        }
        if (entity.voiceNoteFilePath == null) {
          statement.bindNull(11);
        } else {
          statement.bindString(11, entity.voiceNoteFilePath);
        }
        statement.bindLong(12, entity.createdAt);
        statement.bindLong(13, entity.updatedAt);
        final String _tmp = Converters.fromIntList(entity.affectedTeeth);
        if (_tmp == null) {
          statement.bindNull(14);
        } else {
          statement.bindString(14, _tmp);
        }
        statement.bindDouble(15, entity.totalBilled);
        statement.bindDouble(16, entity.totalPaid);
      }
    };
    ...
    this.__updateAdapterOfPatient = new EntityDeletionOrUpdateAdapter<Patient>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `patients` SET `id` = ?,`name` = ?,`phone` = ?,`email` = ?,`dob` = ?,`gender` = ?,`address` = ?,`bloodGroup` = ?,`allergies` = ?,`medicalHistory` = ?,`voiceNoteFilePath` = ?,`createdAt` = ?,`updatedAt` = ?,`affectedTeeth` = ?,`totalBilled` = ?,`totalPaid` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public long insert(final Patient p) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      final long _result = __insertionAdapterOfPatient.insertAndReturnId(p);
  ...
  public void delete(final Patient p) {
    ...
    __db.beginTransaction();
    try {
      __deletionAdapterOfPatient.handle(p);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void update(final Patient p) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __updateAdapterOfPatient.handle(p);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  public LiveData<List<Patient>> getAll() {
    final String _sql = "SELECT * FROM patients ORDER BY updatedAt DESC";
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"patients"}, false, new Callable<List<Patient>>() {
      ...
      public List<Patient> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfVoiceNoteFilePath = CursorUtil.getColumnIndexOrThrow(_cursor, "voiceNoteFilePath");
          final int _cursorIndexOfCreatedAt = CursorUtil.getColumnIndexOrThrow(_cursor, "createdAt");
          final int _cursorIndexOfUpdatedAt = CursorUtil.getColumnIndexOrThrow(_cursor, "updatedAt");
          final int _cursorIndexOfAffectedTeeth = CursorUtil.getColumnIndexOrThrow(_cursor, "affectedTeeth");
          final int _cursorIndexOfTotalBilled = CursorUtil.getColumnIndexOrThrow(_cursor, "totalBilled");
          ...
          while (_cursor.moveToNext()) {
            ...
            if (_cursor.isNull(_cursorIndexOfBloodGroup)) {
              _item.bloodGroup = null;
            } else {
              _item.bloodGroup = _cursor.getString(_cursorIndexOfBloodGroup);
            }
            if (_cursor.isNull(_cursorIndexOfAllergies)) {
              _item.allergies = null;
            } else {
              _item.allergies = _cursor.getString(_cursorIndexOfAllergies);
            }
            if (_cursor.isNull(_cursorIndexOfMedicalHistory)) {
              _item.medicalHistory = null;
            } else {
              _item.medicalHistory = _cursor.getString(_cursorIndexOfMedicalHistory);
            }
            if (_cursor.isNull(_cursorIndexOfVoiceNoteFilePath)) {
              _item.voiceNoteFilePath = null;
            } else {
              _item.voiceNoteFilePath = _cursor.getString(_cursorIndexOfVoiceNoteFilePath);
            }
            _item.createdAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item.updatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            final String _tmp;
            if (_cursor.isNull(_cursorIndexOfAffectedTeeth)) {
              _tmp = null;
            } else {
              _tmp = _cursor.getString(_cursorIndexOfAffectedTeeth);
            }
            _item.affectedTeeth = Converters.toIntList(_tmp);
            _item.totalBilled = _cursor.getDouble(_cursorIndexOfTotalBilled);
            _item.totalPaid = _cursor.getDouble(_cursorIndexOfTotalPaid);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Patient getById(final int id) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (_cursor.isNull(_cursorIndexOfMedicalHistory)) {
          _result.medicalHistory = null;
        } else {
          _result.medicalHistory = _cursor.getString(_cursorIndexOfMedicalHistory);
        }
        if (_cursor.isNull(_cursorIndexOfVoiceNoteFilePath)) {
          _result.voiceNoteFilePath = null;
        } else {
          _result.voiceNoteFilePath = _cursor.getString(_cursorIndexOfVoiceNoteFilePath);
        }
        ...
        _result.affectedTeeth = Converters.toIntList(_tmp);
        _result.totalBilled = _cursor.getDouble(_cursorIndexOfTotalBilled);
        _result.totalPaid = _cursor.getDouble(_cursorIndexOfTotalPaid);
      } else {
        _result = null;
      }
      return _result;
  ...
  @Override
  public List<Patient> search(final String q) {
    final String _sql = "SELECT * FROM patients WHERE name LIKE '%'||?||'%' OR phone LIKE '%'||?||'%' ORDER BY name ASC";
  ...
  public double totalRevenue() {
    final String _sql = "SELECT COALESCE(SUM(totalBilled), 0.0) FROM patients";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
  ...
  public double totalCollected() {
    final String _sql = "SELECT COALESCE(SUM(totalPaid), 0.0) FROM patients";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
